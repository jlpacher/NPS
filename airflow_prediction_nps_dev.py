...
DATAPROC_CLUSTER_NAME = 'prediction-nps-dev-airflow'
...
with DAG(
    dag_id='prediction_nps_dev',
    description='This pipeline runs nps prediction dev',
    ...
    task_save_history_dev = {
        'task_id': 'task_save_history_dev',
        'task_callable': '05_save_history_dev.py'
    }
    ...
    get_dataproc_task(task_save_history_dev) >>
